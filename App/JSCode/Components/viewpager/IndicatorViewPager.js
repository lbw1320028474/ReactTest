...
export default class IndicatorViewPager extends Component {
    ...
    constructor(props) {
        super(props)
        this._onPageScrollStateChangeted = this._onPageScrollStateChangeted.bind(this)
        ...
        return (
            <View style={[styles.container, this.props.style]} >
                <ViewPager
                    ...
                    onPageScrollStateChanged={this._onPageScrollStateChangeted}
    ...
    _onPageSelected(params) {
        ...
        // if (this._currentIndex === this._childrenCount - 1) {
        //     this.setPageWithoutAnimation(0);
        // }
    }
    _onPageScrollStateChangeted(scrollState) {
        this.props.onPageSelected && this.props.onPage(scrollState)
    }
